...
//    tp6Steer(tp6Fps);
//    setTargetSpeed6Right(tp6FpsRight);  // Need to set direction.  Does not set speed!
//    setTargetSpeed6Left(tp6FpsLeft);  // Need to set direction.  Does not set speed!
//  }
//  else {
//    setTargetSpeed6Right(airFps);
//    setTargetSpeed6Left(airFps);
//  }
//  
